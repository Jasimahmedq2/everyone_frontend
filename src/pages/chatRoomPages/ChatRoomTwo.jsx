      ...
      <div className="px-5 py-7 bg-white rounded-2xl shadow-2xl max-w-[708px] overflow-y-auto max-h-screen hide-scrollbar">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col items-center pr-4 pl-9 mt-8 w-full max-md:pl-5 max-md:max-w-full">
            <div className="justify-center items-start self-stretch px-5 py-3 text-xl rounded-md border border-emerald-500 border-solid bg-stone-50 text-zinc-900 max-md:pr-5 max-md:max-w-full">
              Design<span className="font-[275]">|</span>
            </div>
            ...
            <div className="mt-28 ml-2.5 text-base text-zinc-900 max-md:mt-10">
              The Room will be{" "}
              <span className="font-medium text-zinc-900">public</span>, so all
              members can join it.
            </div>
